                ...
                <div class="col-lg-3">
                    <div class="list-group">
                        ...
                        <%
                            ...
                            ArrayList<Category> cat = postdao.getAllCategories();
                            for (Category c : cat) {
                        %>
                        <a href="#" onclick="getAllPosts(<%= c.getcId() %>,this)" class=" c-link list-group-item list-group-item-action"><%=c.getName()%></a>
                        <%
                            }
                        %>
                    </div>
